...
public class BubbleRap_Tugas implements RoutingDecisionEngine, CommunityDetectionEngine, ConnListDecisionEngine, ContactTimeEngine {
    ...
    protected Map<DTNHost, Double> connectTime;
    ...
    public BubbleRap_Tugas(Settings s) {
    ...
    public BubbleRap_Tugas(BubbleRap_Tugas proto) {
        this.community = proto.community.replicate();	//added
        this.centrality = proto.centrality.replicate();
        startTimestamps = new HashMap<DTNHost, Double>();
        connHistory = new HashMap<DTNHost, List<Duration>>();
        connectTime = new HashMap<DTNHost, Double>();
    }
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        BubbleRap_Tugas de = this.getOtherDecisionEngine(peer);

        this.startTimestamps.put(peer, SimClock.getTime());
        de.startTimestamps.put(myHost, SimClock.getTime());
        
        this.connectTime.put(peer, SimClock.getTime());
        de.connectTime.put(myHost, SimClock.getTime());
...
//        double time = startTimestamps.get(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost, DTNHost thisHost) {
        ...
        BubbleRap_Tugas de = getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        BubbleRap_Tugas de = this.getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld) {
        //BubbleRap_Tugas de = this.getOtherDecisionEngine(hostReportingOld);
        //return de.commumesWithHost(m.getTo()) &&
        //		!this.commumesWithHost(m.getTo());
    ...
    public RoutingDecisionEngine replicate() {
        return new BubbleRap_Tugas(this);
    }
    ...
    private BubbleRap_Tugas getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (BubbleRap_Tugas) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
